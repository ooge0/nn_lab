...
# ==== Preconditions, services and otherr checks ================
ensure_nltk_resources()
start_neo4j()

# ============================================================
#   CONFIG & DIRECTORIES & ENTRIES
# ============================================================
RESULTS_DIR = config_loader_short.RESULTS_DIR
LOGS_DIR = config_loader_short.LOGS_DIR
LOG_FILE_ENTRY = config_loader_short.LOG_FILE_ENTRY
KNOWLEDGE_PATH = config_loader_short.KNOWLEDGE_PATH
SYS_PROMPTS_DEFINED_FILE_PATH = config_loader_short.SYS_PROMPTS_DEFINED_FILE_PATH
OPENAI_BASE_URL = config_loader_short.OPENAI_BASE_URL
OPENAI_API_KEY = config_loader_short.OPENAI_API_KEY

os.makedirs(LOGS_DIR, exist_ok=True)
os.makedirs(RESULTS_DIR, exist_ok=True)

LOG_FILE = LOGS_DIR / LOG_FILE_ENTRY.name
logger.remove()
logger.add(LOG_FILE, rotation="10 MB", retention="10 days", level="INFO",
           format="{time:YYYY-MM-DD HH:mm:ss} | {level} | {message}")

# Resources
sys_prompts_defined_file_path = SYS_PROMPTS_DEFINED_FILE_PATH
...
#  MAIN INTERFACE
# ============================================================
# ... - 🛠️ Debug << Tab appearance depends on the SHOW_DEBUG_TAB flag
    ...
    if st.session_state.history:
        ...
        with sub_tab_heatmap:
            ...
            if "sweep_param" in df.columns:
                active_param = df["sweep_param"].iloc[0]  # look at first row, or use a selector
...
with tab_benchmark:
    ...
    if df is None or df.empty:
        ...
        # --- 1. DATA CLEANUP (Logic alignment) ---
        df_clean = df.copy()
...
# ============================================================
with tab_faq:
    st.subheader("📚 User guide & Metric methodology -6")
