...
from core.adapters.rag.chunking import Chunk
...
class FAISSVectorStore:
    ...
    def build(self, chunks: List[Chunk]):
        ...
        texts = [f"{c.archetype} | {c.domain} | {c.content}" for c in chunks]
    ...
    def search(self, query: str, k: int = 5) -> List[Dict]:
        ...
        for idx in indices[0]:
            ...
            results.append({"archetype": chunk.archetype, "domain": chunk.domain, "content": chunk.content})
